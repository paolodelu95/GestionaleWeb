...
/// <summary>
/// Riga di un preventivo (tabella <c>preventivi_righe</c>). Le colonne SQLite
/// sono snake_case: il repository usa alias espliciti verso queste proprietà
...
/// </summary>
public sealed class PreventivoRiga
{
    public long Id { get; set; }
    public long PreventivoId { get; set; }

    /// <summary>Prodotto collegato. NULL = riga libera (descrizione manuale o NOTA).</summary>
    public long? ProdottoId { get; set; }

    /// <summary>Nome prodotto risolto via JOIN (non mappato su una colonna di preventivi_righe).</summary>
