...
/// <summary>
/// Riga di una fattura d'acquisto (tabella <c>acquisti_righe</c>). Le colonne
...
/// </summary>
public sealed class AcquistoRiga
{
    ...
    /// <summary>Nome prodotto risolto via JOIN (non mappato su una colonna di acquisti_righe).</summary>
